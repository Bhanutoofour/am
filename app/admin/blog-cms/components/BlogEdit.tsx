...
export const BlogEdit = () => {
  ...
  const transform = (data: any) => {
    ...
    } else if (data.seoMetadata) {
      // If seoMetadata exists, extract it back to individual fields for editing
      // This is handled in the component by transforming the data when loading
    }
